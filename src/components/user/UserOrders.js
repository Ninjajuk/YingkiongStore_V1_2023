                ...
                <div className="flex items-center border-b border-gray-200 p-4 sm:grid sm:grid-cols-4 sm:gap-x-6 sm:p-6">
                  <dl className="grid flex-1 grid-cols-2 gap-x-6 text-sm sm:col-span-3 sm:grid-cols-3 lg:col-span-2">
                    ...
                    <div className="hidden sm:block">
                      ...
                      <dd className="mt-1 text-gray-500">{getDate(order.createdAt)}</dd>
                  ...
                  <div className="hidden lg:col-span-2 lg:flex lg:items-center lg:justify-end lg:space-x-4">
                    ...
                    {order.status==='delivered'?(
                               ...
                               <p className="ml-2 text-sm font-medium text-gray-500">
                                 Delivered on <span>{getDate(order.updatedAt)}</span>
                                  {/* <time dateTime={order.deliveredDatetime}>{order.updatedAt}</time> */}
                               </p>
                             </div>
                    ):(
                      <span className="mt-1 font-medium text-gray-900">Order status {order.status}</span>
                    )}
                    ...
                    <li key={product.id} className="p-4 sm:p-6">
                      <div className="flex items-center sm:items-start">
                        ...
                        <div className="ml-6 flex-1 text-sm">
                          ...
                          <p className="hidden text-gray-500 sm:mt-2 sm:block">{product.product.description}</p>
                        </div>
                      </div>
